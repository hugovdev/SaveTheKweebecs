...
public class DefaultGameCommand implements CommandExecutor, TabCompleter {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if (sender instanceof Player) {
            ...
            if (args.length == 0) {
                player.sendMessage("§cUsage: /defaultgame §b<game>");
                return true;
            }
            ...
            if (player.isOp()) {
                ...
                if (globalGame != null) {
                    SaveTheKweebecs.getPlugin().setDefaultGame(globalGame);
                    player.sendMessage("§aSet §b" + globalGame.getName() + "§a as the default game!");
                } else {
    ...
    public List<String> onTabComplete(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (command.getName().equalsIgnoreCase("defaultgame") && sender instanceof Player && sender.isOp()) {
